...
//    addLayerToMap("msi", msiLayer, embryo.map);
    ...
    var module = angular.module('embryo.sar.controllers', ["firebase", 'embryo.sar.service']);
    ...
    module.controller("OperationsControl", ['$scope', '$firebase', 'SarService', function ($scope, $firebase, SarService) {
        $scope.sars = []
