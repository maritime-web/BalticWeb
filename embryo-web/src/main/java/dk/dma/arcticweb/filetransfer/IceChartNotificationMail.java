 ...
 */
public class IceChartNotificationMail extends Mail<IceChartNotificationMail>{

    private final Throwable error;
    private final String iceChart;
    private final String provider;
    
    public IceChartNotificationMail(String provider, String iceChart, Throwable t, PropertyFileService propertyFileService) {
    ...
    public IceChartNotificationMail build(){
