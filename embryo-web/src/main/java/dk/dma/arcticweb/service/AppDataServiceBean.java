...
public class AppDataServiceBean {
    ...
    private void createOrasilaTestData() {
        ...
        SecuredUser user = SecurityUtil.createUser("orasila", testPassword, testEmail);
    ...
    private void createOraTankTestData() {
        ...
        SecuredUser user = SecurityUtil.createUser("oratank", testPassword, testEmail);
        user.setRole(sailorRole);
    ...
    private void createSarfaqTestData() {
        ...
        SecuredUser user = SecurityUtil.createUser("sarfaq", testPassword, testEmail);
        user.setRole(sailorRole);
    ...
    private void createNajaArcticaTestData() {
        ...
        SecuredUser user = SecurityUtil.createUser("naja", testPassword, testEmail);
        user.setRole(sailorRole);
    ...
    private void createArinaArcticaTestData() {
        ...
        SecuredUser user = SecurityUtil.createUser("arina", testPassword, testEmail);
        user.setRole(sailorRole);
    ...
    private void createSilverExplorerTestData() {
        ...
        SecuredUser user = SecurityUtil.createUser("silver", testPassword, testEmail);
        user.setRole(sailorRole);
    ...
    private void createArtaniaTestData() {
        ...
        SecuredUser user = SecurityUtil.createUser("artania", testPassword, testEmail);
        user.setRole(sailorRole);
    ...
    private void createEmeraldPrincessTestData() {
        ...
        SecuredUser user = SecurityUtil.createUser("princess", testPassword, testEmail);
        user.setRole(sailorRole);
    ...
    private void createCarnivalLegendTestData() {
        ...
        SecuredUser user = SecurityUtil.createUser("carnivalLegend", testPassword, testEmail);
        user.setRole(sailorRole);
    ...
    private void createArcticCommandLogin() {
        ...
        SecuredUser user = SecurityUtil.createUser("arcticCommand", testPassword, testEmail);
        user.setRole(role);
    ...
    private void createAasiaatLogin() {
        ...
        SecuredUser user = SecurityUtil.createUser("aasiaat", testPassword, testEmail);
        user.setRole(role);
        vesselDao.saveEntity(user);
    }
    ...
    private void createNanoqLogin() {
        ...
        SecuredUser user = SecurityUtil.createUser("nanoq", testPassword, testEmail);
        user.setRole(role);
        vesselDao.saveEntity(user);
    }
    ...
    private void createDmiLogin() {
        ...
        SecuredUser user = SecurityUtil.createUser("dmi", testPassword, testEmail);
        user.setRole(role);
        vesselDao.saveEntity(user);
    }
    ...
    private void createGreenposReports() {
        ...
        report = new GreenPosPositionReport(vessel.getAisData().getName(), vessel.getMmsi(), vessel.getAisData()
                .getCallsign(), new Position("66 03.772N", "053 46.3W"), "Sun shine", "NO ICE", 10.0, 10, null);
        report.setReportedBy("oratank");
        report.setRecipient("greenpos");
        ...
        report = new GreenPosPositionReport(vessel.getAisData().getName(), vessel.getMmsi(), vessel.getAisData()
                .getCallsign(), new Position("65 19.926N", "052 57.483W"), "Sun shine", "NO ICE", 10.0, 10, null);
        report.setReportedBy("oratank");
        report.setRecipient("greenpos");
        ...
        report = new GreenPosPositionReport(vessel.getAisData().getName(), vessel.getMmsi(), vessel.getAisData()
                .getCallsign(), new Position("64 29.198N", "052 29.507W"), "Sun shine", "NO ICE", 10.0, 10, null);
        report.setReportedBy("oratank");
        report.setRecipient("greenpos");
        ...
        report = new GreenPosFinalReport(vessel.getAisData().getName(), vessel.getMmsi(), vessel.getAisData()
                .getCallsign(), new Position("64 10.4N", "051 43.5W"), "Sun shine", "NO ICE", null);
        report.setReportedBy("oratank");
        report.setRecipient("greenpos");
        ...
        report = new GreenPosPositionReport(vessel.getAisData().getName(), vessel.getMmsi(), vessel.getAisData()
                .getCallsign(), new Position("63 80.01N", "051 58.04W"), "Sun shine", "NO ICE", 11.6, 350, null);
