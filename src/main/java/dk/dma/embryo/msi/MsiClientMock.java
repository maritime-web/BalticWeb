...
public class MsiClientMock implements MsiClient {
    ...
    public List<MsiItem> getActiveWarnings() {
        try {
            ...
            result.add(new MsiItemMock(DATE_FORMAT.parse("2013-10-10"), "Shoal (TEST)", 72.7516667, -056.2500000, "Greenland West", "Upernavik",
            ...
            result.add(new MsiItemMock(DATE_FORMAT.parse("2013-10-07"), "Inoperative Beacon (TEST)", 63.6978333, -051.6053333, "Greenland West", "Kangerluarsoruseq",
            ...
            result.add(new MsiItemMock(DATE_FORMAT.parse("2013-10-02"), "Shoal (TEST)", 72.0283333, -056.0416667, "Greenland West", "Svartenhuk",
            ...
            result.add(new MsiItemMock(DATE_FORMAT.parse("2013-09-28"), "Lost Trawl (TEST)", 68.1900000, -053.9583333, "Greenland West", "Simiutarsuup",
            ...
            result.add(new MsiItemMock(DATE_FORMAT.parse("2013-09-30"), "Lost Dinghy (TEST)", 64.142664, -51.615843, "Greenland West", "Nuuk Fiord",
