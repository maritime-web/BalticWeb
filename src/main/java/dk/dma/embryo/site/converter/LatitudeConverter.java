...
public class LatitudeConverter implements IConverter<Double> {
    ...
    public Double convertToObject(String value, Locale locale) {
        ...
        return ParseUtils.parseLatitude(value);
    }
    ...
    public String convertToString(Double value, Locale locale) {
        ...
        return Position.create(value, 0).getLatitudeAsString();
    }

    public static LatitudeConverter get() {
        return new LatitudeConverter();
    }
}
